...
const PreFooter = () => {
  return (
    <div className="relative w-full h-[26.7rem] px-4 rounded-[0.8rem] flex-col bg-primary-1 flex justify-center items-center gap-[1.67rem]">
      ...
      <button className=" z-1 relative rounded-[0.75rem] px-[1.3rem] py-[0.66rem] bg-info-1 hover:opacity-95 active:opacity-100 duration-300 transition-opacity ease-in-out">
