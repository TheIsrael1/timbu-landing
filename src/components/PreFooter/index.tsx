...
const PreFooter = () => {
  return (
    <div className="relative w-full h-[26.7rem] rounded-[0.8rem] flex-col bg-primary-1 flex justify-center items-center gap-[1.67rem]">
      <img
      ...
      />
      <h5 className="text-white text-[3.5rem] font-[900] leading-[4.5rem] text-center">
        Are you ready to timbu?
      </h5>
      <p className="text-white text-[0.8rem] leading-[1.25rem] tracking-[0.00419rem]">
